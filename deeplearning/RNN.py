...
alpha, iteration = (2, 300)
pixel_per_image, num_labels = (784, 10)
batch_size = 128
...
hidden_size = ((input_row - kernel_rows) * (input_col - kernel_cols)) * num_kernels

kernels = 0.02 * np.random.random((kernel_cols * kernel_rows, num_kernels)) - 0.1
weight1_2 = 0.02 * np.random.random((hidden_size, num_labels))
